            ...
            <form action="{{route('biodata.store')}}" method="post" enctype="multipart\form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" name="nomer_hp" required class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_kelamin" class="form-control">
                            <option value="kaki-laki">Laki - laki</option>
                            <option value="perempuan">Perempuan</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Poto Profile</label>
                        <input type="file" name="foto-profile" id="" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
...
@else
{{-- jika user sudah melengkapi data  --}}
